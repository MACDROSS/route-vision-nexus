          ...
          <Card>
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                <Badge variant="outline" className={`ml-2 ${impacts.costNetChange > 0 ? "bg-red-100" : "bg-green-100"}`}>
          ...
          <Card>
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                <Badge variant="outline" className={`ml-2 ${impacts.revenueNetChange >= 0 ? "bg-green-100" : "bg-red-100"}`}>
